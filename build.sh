...
if [ ! -e './stamps/04' ]; then
	if ! (
		...
		chroot rootfs ${lnx} emerge boot-update wicd squashfs-tools firefox-bin adobe-flash geany porthole xorg-x11 dialog cdrtools lightdm genkernel xfce4-meta --autounmask-write --verbose --ask n
